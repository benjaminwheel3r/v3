...
d3 <- read.table(paste(getwd()[1],"v3_AllTags_002_AllSources_analysis_v3_310_noNA.txt",sep = '/'),
...
plot(d3$Candidate_VS~d3$perc_white_comb)
plot(d3$Candidate_VS~d3$perc_white)
...
plot(RepTKC$Candidate_VS~)



RepTKC$White_and_combination
```
