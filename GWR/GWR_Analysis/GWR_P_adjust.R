gwr.t.adjust_BHW <- function(gwm.Obj)
{
  ...
  bey_pvals <- p.adjust(pvals, "BY", n = ntests)   # Removed Round() from function
  beh_pvals <- p.adjust(pvals, "BH", n = ntests)   # Removed Round() from function
