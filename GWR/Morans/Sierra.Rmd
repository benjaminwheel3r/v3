...
California counties downloaded from ArcGIS and saved in data folder,  path accessed as ```getwd()``` from working directory set above by ```setwd()s```
